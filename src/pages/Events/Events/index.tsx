  ...
  return (
    <Page title='Đơn vị hợp tác - Fessior Community'>
      <main className='flex w-full flex-col px-6 py-5 lg:px-10 lg:py-7 xl:px-20 3xl:px-[100px] 3xl:py-9'>
        <section
          id='ctct-banner'
          className='relative -mx-6 -mt-5 flex h-[8rem] w-screen flex-row  items-center justify-center md:m-0 md:h-[10rem] md:w-full lg:h-[18rem]'
        >
          <LazyLoadImage
        ...
        {width > 768 && (
          <div className='mt-[1rem] flex flex-col justify-center gap-2 md:mt-[1.25rem] lg:mt-[1.75rem] lg:gap-4 xl:mt-[2.25rem] 2xl:gap-5 3xl:mt-[2.5rem]'>
        ...
        <div className='mt-[1.25rem] flex flex-col justify-center gap-2 lg:mt-[1.75rem] lg:gap-4 xl:mt-[2rem] 2xl:gap-5 3xl:mt-[2.25rem]'>
          <div className='relative flex w-full flex-[2] items-center'>
            <input
              className='flex w-full flex-1 rounded-lg border border-[#CCC] p-1 text-sm font-medium md:text-base lg:p-3 lg:text-lg 3xl:p-5'
              value={filterName}
              onChange={({ target }) => {
